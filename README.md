...
<img width="669" alt="Screenshot 2023-07-24 at 7 41 39 PM" src="https://github.com/myplancash/boss-machine/assets/64751892/19244b62-9ba5-4a75-8481-6bbbfe0a594e">
...
## Start the server
Start the server listening on the provided PORT, Make sure to use the PORT constant and not a hard-coded number

For practicallity you can install "Live Server" a Vscode server extension and click the live server's right-bottom button to see the app.
